...
export const TOOLS: Tool[] = [
  ...
  { name: 'Node.js', category: 'Automation & Pipelines' },
  { name: 'Webhooks', category: 'Automation & Pipelines' },
  { name: 'React', category: 'Product & APIs' },
  { name: 'React Native', category: 'Product & APIs' },
  { name: 'TypeScript', category: 'Product & APIs' },
  { name: 'REST APIs', category: 'Product & APIs' },
